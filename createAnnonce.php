...
<form action="signinSuite.php" method="post" class="form-autre">
		...
		<option value="false" disabled selected>Selectionne l'école:*</option>
     ...
     <select required name="typeannonce" id="typeannonce type" value="Type d'annonce">
                <option value="tout" >Selectionne le type de ton annonce:*</option>
     ...
     <input type="text" id="titreAnnonce titre" name="titreAnnonce" required
           minlength="4" maxlength="10" size="40" placeholder="Écris le titre de ton annonce:*"> <br>


	<h2 class="ajouterphoto"> Ajoute une photo</h2>	
	...
	<script>
     ...
     <br>
    <textarea class="big" type="text" id="legende" name="legende" 
       minlength="0" maxlength="300"  rows="5" cols="33" placeholder="Ici, Tu peux mettre une légende à ton image"></textarea>

    <br>
    <textarea class="big " type="text" id="description" name="description" 
      required minlength="0" maxlength="300"  rows="5" cols="33" placeholder="Ici, Tu dois décrire ta recherche ou ta proposition:*"></textarea>

        <br>
		<div class="question"></div>

	<div class="navbar fixed-navbar">
       <button type="submit" id="publier" class="btnCreateIdea" name="publier" value="publier" 
	    size="10"><span>Publier</span></button>
	</div>
